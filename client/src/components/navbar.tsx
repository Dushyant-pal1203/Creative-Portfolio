  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
      >
        <span className="relative z-10 block px-6 py-2 text-sm font-bold border rounded-xl border-white/20 text-white group-hover:text-black hover:bg-primary transition-colors duration-300">
          LET'S TALK
        </span>
        <motion.span
